...
By default otl-admin has three built-in color profiles: ng2 (default blue sheme), mint and blur.
This article will help you to create your own color profile.
Let's say you want to make otl-admin dark theme.
...
- If you want to know how to change the theme to blur, read the [following article](/otl-admin/articles/014-switch-to-blur-theme/)