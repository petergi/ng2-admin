...
### Note
Not all packages used in otl-admin support RC5 at the moment, so we suggest waiting until otl-admin@0.5.1 version for a complete support of RC5.
...
* We introduced NgaModule - wrapper for all otl-admin features. At the moment it includes everything (directives, services, configs, etc). But, the important thing is that we are planning to refactor it and divide into smaller modules, so that if you don't need a whole list of features somewhere in your code - you can simply import a smaller part. [Here are some more details](https://github.com/akveo/otl-admin/issues/179).
...
* Missed new component [ng2-smart-table](https://akveo.github.io/ng2-smart-table/) - [demo](http://akveo.com/otl-admin/#/pages/tables/smarttables)
...
* New component [ng2-smart-table](https://akveo.github.io/ng2-smart-table/) - [demo](http://akveo.com/otl-admin/#/pages/tables/smarttables)
...
More details on how to configure a new route you can find [here](https://akveo.github.io/otl-admin/articles/015-sidebar/).
...
* Dependencies updated accordingly
* Login page component [Demo](http://akveo.com/otl-admin/#/login)
* Sign up page component [Demo](http://akveo.com/otl-admin/#/register)
